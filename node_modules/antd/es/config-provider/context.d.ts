...
export type AlertConfig = ComponentStyleConfig & Pick<AlertProps, 'variant' | 'closeIcon' | 'classNames' | 'styles'> & {
    closable?: boolean | (Pick<Exclude<NonNullable<AlertProps['closable']>, boolean>, 'closeIcon'> & React.AriaAttributes);
    successIcon?: React.ReactNode;
    infoIcon?: React.ReactNode;
    warningIcon?: React.ReactNode;
    errorIcon?: React.ReactNode;
