...
const computeClosableConfig = (closable, closeIcon) => {
  ...
  if (!(0, _util.isNonNullable)(closable) && !(0, _util.isNonNullable)(closeIcon)) {
    return null;
  }
  let closableConfig = {
    closeIcon: typeof closeIcon !== 'boolean' && (0, _util.isNonNullable)(closeIcon) ? closeIcon : undefined
  };
...
const computeCloseIcon = (mergedConfig, fallbackCloseCollection, closeLabel) => {
  ...
  if ((0, _util.isNonNullable)(finalCloseIcon)) {
    if (closeIconRender) {
